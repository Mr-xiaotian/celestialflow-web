...
export var currentLang: Lang = "zh-CN"; // 当前全局语言，默认使用中文
...
const translations: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.structureEdgeLabel": "结构图边标签",
    "settings.structureEdgeLabelNone": "无",
    "settings.structureEdgeLabelDelta": "增量",
    "settings.structureEdgeLabelCumulative": "累计",
    "settings.statusTotalPending": "节点等待使用全局估计",
    "settings.injectionInjectableOnly": "仅显示可注入节点",
    "settings.editLayout": "编辑卡片布局",
    "settings.editErrorColumns": "编辑表格字段",
    ...
    "errors.colTime": "时间",
    "errors.colRetry": "重试",
    "errors.columns.title": "表格字段",
    "errors.columns.visible": "已显示字段",
    "errors.columns.hidden": "未显示字段",
    "errors.columns.save": "保存并关闭",
    "errors.columns.reset": "重置默认",
    "errors.retryInject": "任务注入",
    "errors.retryUnavailable": "格式未知",
    "errors.noRecords": "没有错误记录",
    "errors.noVisibleColumns": "当前未显示任何字段，请在设置中重新选择",
    "errors.prevPage": "上一页",
    "errors.nextPage": "下一页",
    "errors.tip":
    ...
    "chart.metric.deltaSkipped": "跳过趋势",
  ...
  en: {
    ...
    "settings.structureEdgeLabel": "Structure Edge Label",
    "settings.structureEdgeLabelNone": "None",
    "settings.structureEdgeLabelDelta": "Delta",
    "settings.structureEdgeLabelCumulative": "Cumulative",
    ...
    "settings.editErrorColumns": "Edit Table Columns",
    ...
    "errors.columns.title": "Table Columns",
    "errors.columns.visible": "Visible Columns",
    "errors.columns.hidden": "Hidden Columns",
    "errors.columns.save": "Save and Close",
    "errors.columns.reset": "Reset Default",
    "errors.retryInject": "Inject",
    "errors.retryUnavailable": "Bad Format",
    "errors.noRecords": "No error records",
    "errors.noVisibleColumns":
      "No columns are currently visible. Re-enable them in settings.",
    ...
    "analysis.graphModeHelp":
      "The execution mode of the whole graph. serial starts stages sequentially, thread starts stages with threads, and async runs the graph asynchronously.",
    ...
    "chart.metric.deltaSkipped": "Skip Rate",
  ...
  ja: {
    ...
    "settings.structureEdgeLabel": "構造図のエッジラベル",
    "settings.structureEdgeLabelNone": "なし",
    "settings.structureEdgeLabelDelta": "増分",
    "settings.structureEdgeLabelCumulative": "累計",
    "settings.statusTotalPending": "ノード待機に全体推定値を使う",
    "settings.injectionInjectableOnly": "注入可能なノードのみ表示",
    "settings.editLayout": "カードレイアウト編集",
    "settings.editErrorColumns": "テーブル列を編集",
    ...
    "errors.colTime": "時刻",
    "errors.colRetry": "再試行",
    "errors.columns.title": "テーブル列",
    "errors.columns.visible": "表示中の列",
    "errors.columns.hidden": "非表示の列",
    "errors.columns.save": "保存して閉じる",
    "errors.columns.reset": "初期値に戻す",
    "errors.retryInject": "注入する",
    "errors.retryUnavailable": "形式不明",
    "errors.noRecords": "エラー記録なし",
    "errors.noVisibleColumns":
      "現在表示中の列がありません。設定から再度選択してください。",
    ...
    "chart.metric.deltaSkipped": "スキップトレンド",
 ...
 */
export function applyI18nDOM(): void {
  // 批量替换直接显示文本的元素内容。
