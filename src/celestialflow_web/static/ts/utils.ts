 ...
 */
export function renderLabelWithTooltip(labelKey: string, tooltipKey: string): string {
 ...
 * @returns {void}
 */
export function switchToErrorsTab(nodeFilter: string = ""): void {
 ...
 * @returns {void}
 */
export function switchToInjectionTab(): void {
 ...
 */
export function formatAvgTime(elapsed: number, processed: number): string {
 ...
 */
export function format_repr(obj: unknown, max_length: number): string {
