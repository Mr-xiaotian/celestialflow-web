 ...
 */
function buildGraphIndex(edges: GraphEdges): GraphIndex {
 ...
 */
function topoSort(edges: GraphEdges): string[] | null {
...
function calcGlobalPending(
  ...
  const expectedPending: CountMap = {};
  ...
  for (const node of topoOrder) {
    ...
    const nodeScale: Record<string, number> = {};
