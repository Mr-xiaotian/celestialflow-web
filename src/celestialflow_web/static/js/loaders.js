...
// ==== 节点状态模型 ====
export let nodeStatuses = {}; // 当前各节点运行状态
export let lastNodeStatuses = {}; // 上一轮状态快照，用于计算增量
export let nodeEstimates = {}; // 本轮图级派生值，与 nodeStatuses 同步轮转
export let lastNodeEstimates = {}; // 上一轮派生值，用于计算增量
